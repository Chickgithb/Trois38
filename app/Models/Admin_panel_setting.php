...
class Admin_panel_setting extends Model
{
    ...
    protected $fillable = ['company_name', 'saysem_status', 'image', 'phones', 'address', 'email', 'added_by', 'updated_by', 'com_code',
       ...
       'monthly_vacation_balance', 'after_days_begin_vacation', 'first_balance_begin_vacation',
        'sanctions_value_first_abcence', 'sanctions_value_second_abcence', 'sanctions_value_thaird_abcence',
